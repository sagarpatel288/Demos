...
import com.example.android.stackexchange.model.StackSearchListItem;
...
public interface ApiInterface {
    ...
    @GET(Api.API_SEARCH)
    Call<StackSearchListItem> callApiSearchByTag(@Query("page") int page, @Query("paegsize") int paginationLimit,
